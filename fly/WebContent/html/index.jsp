...
<div class="header">
  <div class="main">
    ...
    <div class="nav-user">
      ...
      <a class="unlogin" href="user/home.jsp"><i class="iconfont icon-touxiang"></i></a>
      <span >${userinfo.nickName }:您好</span>
      <span><a href="user/login.jsp">登入</a><a href="/fly/regServlet?flag=reg">注册</a></span>
      <p class="out-login">
  ...
  <div class="wrap">
    <div class="content">
      <div class="fly-tab fly-tab-index">
        ...
        <a href="/fly/postServlet?flag=check" class="layui-btn jie-add">发布问题</a>
      </div>
      ...
      <ul class="fly-list">
        ...
        <li class="fly-list-li">
         ...
         <c:forEach items="${list}" var="p">
          ...
          <h2 class="fly-tip">
            <a href="/fly/postServlet?flag=postInfo&pid=${p.pid }">${p.title }</a>
          </h2>
          <p>
            <span><a href="user/home.html">${p.nickName }</a></span>
            <span>${p.startime }</span>
            <span>
            	<c:if test="${p.pcid.id==1}">
            		layui框架综合
            	</c:if>
            	<c:if test="${p.pcid.id==2}">
            		layui.mobile模块
            	</c:if>
            	<c:if test="${p.pcid.id==3}">
            		layer弹出层
            	</c:if>
            </span>
            <span class="fly-list-hint"> 
              <i class="iconfont" title="回答">&#xe60c;</i> ${p.revert }
              <i class="iconfont" title="人气">&#xe60b;</i> ${p.click }
            </span>
          </p>
        </li>
         </c:forEach>
...
<!-- <script type="text/javascript">
	window.onload=function(){
		location.href="/fly/selPostServlet";
	}
</script> -->
</body>
</html>