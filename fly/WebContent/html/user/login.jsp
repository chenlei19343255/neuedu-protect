      ...
      <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
        <div class="layui-tab-item layui-show">
          <div class="layui-form layui-form-pane">
            <form action="/fly/loginServlet" method="post" id="formid">
              <div class="layui-form-item">
                <label for="L_email" class="layui-form-label">邮箱</label>
                <div class="layui-input-inline">
                  <input type="text" value="${userinfo.email }" id="L_email" name="email" required lay-verify="required" autocomplete="off" class="layui-input">
                </div>
                 <div class="layui-form-mid layui-word-aux">${error1 }</div>
              </div>
              <div class="layui-form-item">
                <label for="L_pass" class="layui-form-label">密码</label>
                <div class="layui-input-inline">
                  <input type="password" value="${userinfo.password }" id="L_pass" name="pass" required lay-verify="required" autocomplete="off" class="layui-input">
                </div>
                 <div class="layui-form-mid layui-word-aux">${error2 }</div>
              </div>
           <!--    <div class="layui-form-item">
                ...
                <div class="layui-form-mid">
                  <span style="color: #c00;">sd12</span>
                </div>
              </div> -->
              <div class="layui-form-item">
                <button onclick="userLogin();" class="layui-btn" lay-filter="*" lay-submit>立即登录</button>
